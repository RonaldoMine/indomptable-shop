...
function Checkout() {
    ...
    const handleInitPayment = async (values: any) => {
        ...
        const options = {
            ...
            body: JSON.stringify({...values, quantity: basket.totalProduct, amount: (basket.subTotal + 1000)}),
        }
                        ...
                        basket.totalProduct > 0 ? <>
                            ...
                            <div className={"col-span-2 relative"}>
                                ...
                                {(paymentStatus !== PaymentStatus.PENDING && paymentStatus !== PaymentStatus.CREATED) && (
                                    <div className="transition-all absolute w-full h-full bg-white z-10 p-4 shadow-lg">
                                        <div className="flex flex-col h-full justify-center items-center">
                                            <div className="text-center">
                                            ...
                                            <button className={"text-gradient underline mt-4 flex aligns-center"}
                                                    onClick={handleBackToShop}>
                                                <BiArrowBack className={"mr-2"}/> <span>Retour à la boutique</span></button>
                                        </div>
                                    </div>)}
                                ...
                                <form onSubmit={handleSubmit(handleInitPayment)}>
                                    <div className="grid md:grid-cols-2 grid-cols-1 md:gap-x-8 md:gap-y-8 gap-4">
                                        <div>
                                            <input type="text"
                                                   className={"form-control rounded"} {...register("firstname", {
                                                required: true,
                                        ...
                                        <div>
                                            <input type="text" className={"form-control rounded"} {...register("lastname", {
                                                required: true,
                                        ...
                                        <div>
                                            <input type="email" className={"form-control rounded"} {...register("email", {
                                                required: true,
                                        ...
                                        <div>
                                            <input type="number" {...register("phoneNumber", {
                                                required: true
                                            })} defaultValue={"675710605"} className={"form-control rounded"}
                                    ...
                                    <div className={"col-span-2 mt-4"}>
                                        <input type="text" {...register("address", {
                                            required: true
                                               ...
                                               className={"form-control rounded"} placeholder="Address *"/>
                                        <span
