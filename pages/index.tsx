    ...
    return (
        <div
            ...
            <main className='md:px-32 px-10 py-6 relative z-10'>
                ...
                <div className='sm:flex justify-center items-center mt-4 sm:mt-0 mx-auto'>
                    <div className="md:grid flex justify-around md:w-40 md:justify-items-start rounded-full mr-5 mb-4">
                        <button className={`w-10 h-10 rounded-full flex justify-center items-center ${styles.item}`}>
