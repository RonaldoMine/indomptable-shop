                ...
                >
                    <SwiperSlide className={"w-full"}>
                        <p className={"mx-auto text-center w-2/3 sm:w-1/2"}>
                            Lorem ipsum <br/>
                            dolor sit amet, consectetur adipisicing elit. Asperiores beatae ea ex illo itaque
                            iure magnam nam omnis recusandae veritatis! Aliquam consequatur cum distinctio doloremque
                            quod
