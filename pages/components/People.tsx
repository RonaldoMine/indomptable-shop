    ...
    return (
        <div className="dark:bg-neutral-800" id="our-community">
            <div className="p-4">
                ...
                <div id="masonry-grid"
                     className="md:columns-3 lg:columns-4 justify-items-center 2xl:columns-5 lg:columns-4 md:columns-3 sm:columns-2 sm:gap-4">
                    {peoples.map((people: { src: any; title: string; }, key: number) => {
                        return <OnePeople onClick={() => openModal(urlFor(people.src).url(), people.title, key)}
                                          key={key}
