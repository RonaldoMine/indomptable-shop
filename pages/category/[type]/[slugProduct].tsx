    ...
    return (
        <>
            <div className="w-full overflow-x-hidden dark:bg-neutral-800 relative">
                ...
                <div
                    className="min-h-full max-w-[75rem] mx-auto px-8 sm:px-12 py-20 grid grid-cols-1 min-[960px]:grid-cols-6 sm:gap-14">
                    <div
                        id="left-pane"
              ...
              />
                    ...
                    >
                        ...
                        <p className="mt-5">XAF <span className={"text-md mr-2 font-bold"}>{product?.pricePromo}</span>
                            <span
