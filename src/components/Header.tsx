...
export default function Header({ lang }: { lang: string }) {
  ...
  return (
    <header
      className={
        `sticky ${visible ? 'top-0' : '-top-32 md:-top-20'} z-50 duration-150 transition-[top] delay-300 dark:bg-neutral-800 dark:border-b-neutral-500 dark:border-b shadow-md`
      }
    >
