...
export default function Footer({ lang }: { lang: string }) {
  ...
  return (
    <footer className="px-10 py-12 relative dark:bg-neutral-800 border-t border-t-neutral-200 dark:border-t-neutral-600">
        ...
        <div className={"grid gap-4 grid-cols-2 sm:grid-cols-3"}>
          <div>
            <ul>
              ...
              <li>
                <button className="text-left" onClick={handleGoToAboutUs}>
