...
export default function OurStory() {
    ...
    return (
        <>
            ...
            >
                <blockquote className={"lg:w-3/6 md:w-4/6 w-full p-4 mx-auto text-center"}>
                    <h1 className={"text-center text-4xl md:text-6xl font-bold text-gradient"}>
                        {t("title")}
                    </h1>
                    <div className={"relative mt-10"}>
                        ...
                        <p className={"md:text-3xl sm:text-2xl text-1xl pt-10 pb-10"} dangerouslySetInnerHTML={{__html: t("description")}}/>
                        <svg
                    ...
                    <p className={"pt-5 sm:pt-10"}>
                        <Link className={"text-orange"} href={"/about"}>{t("read-more")}</Link>
                    </p>
                </blockquote>
            </div>
        </>
