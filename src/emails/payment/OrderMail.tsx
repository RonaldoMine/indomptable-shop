                                ...
                                <table role="presentation" border={0} cellPadding="0" cellSpacing="0" width="100%">
                                    <tr>
                                        <td style={{padding: "0 2.5em", textAlign: "left"}}>
                                            <div className="text">
                                                <h3 style={styles.h3}
                                                    dangerouslySetInnerHTML={{__html: langMessages.salutation.replace(":lastName", lastName)}}/>
                                                <h3 style={styles.h3}
                                                    dangerouslySetInnerHTML={{__html: langMessages.description.replace(":reference", reference)}}/>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <table className="bg_white" role="presentation" border={0} cellPadding="0" cellSpacing="0"
                                ...
                                <tr style={{borderBottom: "1px solid rgba(0,0,0,.05)"}}>
                                    <th
                                        style={{
                                            ...
                                            padding: "0 2.5em",
                                            paddingBottom: "20px"
                                        }} dangerouslySetInnerHTML={{__html: langMessages.products}}/>
                                    <th
                                        style={{
                                            textAlign: "right",
                                            padding: "0 2.5em",
                                            paddingBottom: "20px"
                                        }} dangerouslySetInnerHTML={{__html: langMessages.quantity}}/>
                                    <th
                                        style={{
                                            textAlign: "right",
                                            padding: "0 2.5em",
                                ...
                                <tbody>
                                {
                                    products.map((product) => {
                                        return (
                                            <tr key={product.sku} style={{borderBottom: "1px solid rgba(0,0,0,.05)"}}>
                    ...
                    <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border={0} width="100%"
                        ...
                        <tr>
                            <td style={{
                                ...
                                <h3 style={{color: "#EE1413FF"}}>{langMessages.deliveryAddress}</h3>
                                <address style={{
